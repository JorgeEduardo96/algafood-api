...
public interface UsuarioControllerOpenApi {
    ...
    UsuarioModel adicionar(
            @RequestBody(description = "Representação de um novo usuário", required = true) UsuarioInput usuarioInput);
    ...
    UsuarioModel atualizar(
            ...
            @RequestBody(description = "Representação de um usuário com os novos dados", required = true) UsuarioSemSenhaInput usuarioSemSenhaInput);
