...
public interface FormaPagamentoControllerOpenApi {
    ...
    ResponseEntity<FormaPagamentoModel> buscar(
            @ApiParam(value="ID de uma forma de pagamento", example = "1")Long idFormaPagamento,
    ...
    FormaPagamentoModel atualizar(@ApiParam(value="ID de uma forma de pagamento", example = "1") Long idFormaPagamento,
                                  @ApiParam(name="corpo", value="Representação de uma forma de pagamento com os novos dados")
                                          FormaPagamentoInput formaPagamentoInput);

    @ApiOperation("Exclui uma forma de pagamento por ID")
    void remover(@ApiParam(value="ID de uma forma de pagamento", example = "1") Long idFormaPagamento);
